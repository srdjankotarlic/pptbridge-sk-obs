...
- Optional `Tools > PPTBridge SK: Spotlight/Clicker Capture On/Off` captures presenter remote keys such as `PageDown` and `PageUp`, routes the stage clicker to PPTBridge, and suppresses only those captured clicker keys from the focused app.

...
- **[Download macOS Apple Silicon v0.5.12](https://github.com/srdjankotarlic/pptbridge-sk-obs/releases/download/v0.5.12/pptbridge-obs-macos-apple-silicon.zip)**
...
Windows x64 is stable on `v0.5.10`. macOS Apple Silicon is stable on `v0.5.12` and uses its separate download.

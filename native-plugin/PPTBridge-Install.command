...
echo "   - Next Slide defaults to 2 or Right Arrow"
echo "   - Previous Slide defaults to 1 or Left Arrow"
echo "   - Spotlight/Clicker Capture uses PageDown/Right and PageUp/Left"
echo ""

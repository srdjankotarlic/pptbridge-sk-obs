...
Windows x64 `v0.5.10` and macOS Apple Silicon `v0.5.12` are stable release platforms. This document keeps the Windows engineering architecture and remaining limits explicit.
